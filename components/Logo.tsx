...
function Logo({ fontSize = "text=2xl", iconSize = 20}: {fontSize?: string; iconSize?: number}) {
  ...
  >
    <div className='rounded-xl bg-gradient-to-r from-purple-500 to-purple-950 p-2'>
        <SquareDashedMousePointer size={iconSize} className='stroke-white'/>
    </div>
    <div>
        <span className='bg-gradient-to-r from bg-purple-700 to-purple-800 bg-clip-text text-transparent'>
            Flow
        </span>
