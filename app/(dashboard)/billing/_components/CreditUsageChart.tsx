        ...
        <CardContent>
            <ChartContainer config={chartConfig} className='max-h-[200px] w-full'>
                <BarChart data={data} height={200} accessibilityLayer margin={{top:20}}>
                    ...
                    <Bar fill='var(--color-success)' radius={[0,0,4,4]} fillOpacity={0.8} stroke='var(--color-success)' stackId={"a"} dataKey={"success"}/>
                    <Bar fill='var(--color-failed)' radius={[4,4,0,0]} fillOpacity={0.8} stroke='var(--color-failed)' stackId={"a"} dataKey={"failed"}/>
                </BarChart>
            </ChartContainer>
        </CardContent>
    </Card>
