...
function StatsCardSkeleton(){
  return(
     <div className="grid group-3 lg:gap-8 lg:grid-cols-3">
        {[1,2,3].map((i) => (
...
async function CreditsUsageInPeriod({selectedPeriod}: {selectedPeriod: Period}) {
  ...
  return (
      <CreditsUsageChart data={data} title='Daily credits spent' description="Daily credits consumed in selected period"/>
  )
}
